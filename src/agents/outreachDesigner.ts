...
- hook: a SHORT observation CLAUSE (aim for one brief phrase, NO trailing period) that names something concrete about the company, grounded ONLY in the input or a real Exa/WebFetch result — no fabricated facts. It is inserted as the start of the sentence "<hook> caught my attention because...", so it must read grammatically as the subject of that sentence. Good: "Your work on autonomous coding agents" / "The way you're rethinking LLM evals". Bad: a full sentence, or anything ending in a period. Do NOT count characters or run any shell command to check the length — a hard cap is applied automatically in code, so just write a naturally short phrase and move on.
